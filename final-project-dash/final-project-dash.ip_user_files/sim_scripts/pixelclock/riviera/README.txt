...
#
# Generated by export_simulation on Sun Dec 05 17:32:08 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './pixelclock.sh' script.

./pixelclock.sh -reset_run
...
./pixelclock.sh -noclean_files

For more information on the script, please type './pixelclock.sh -help'.
