...
#
# Generated by export_simulation on Sun Dec 05 21:01:05 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './DashRom.sh' script.

./DashRom.sh -reset_run
...
./DashRom.sh -noclean_files

For more information on the script, please type './DashRom.sh -help'.
